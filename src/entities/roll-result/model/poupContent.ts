...
const defaultState: PopupContent = {values: '', description: '', total: 0, type: 'simple'}

const popupContentReducer = (state: PopupContent = defaultState , action: PopupContentAction): PopupContent => {
    switch(action.type){
