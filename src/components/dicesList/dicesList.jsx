...
const DicesList = () => {
    ...
    let k100Image = <svg width="75" height="75" viewBox="0 0 35 35" fill="none" stroke="white"><path d="M10.698 1.04761L19.9948 10.6565M10.698 1.04761L1.40112 10.6565M10.698 1.04761L15.2207 9.98216M10.698 1.04761L6.17517 9.98216M19.9948 10.6565L10.698 20.3496M19.9948 10.6565L15.2207 9.98216M10.698 20.3496L1.40112 10.6565M10.698 20.3496V12.1737M1.40112 10.6565L6.17517 9.98216M10.698 12.1737L15.2207 9.98216M10.698 12.1737L6.17517 9.98216" stroke="inherit"></path><path d="M23.4478 13.7974L32.7447 23.4062M23.4478 13.7974L14.151 23.4062M23.4478 13.7974L27.9706 22.7319M23.4478 13.7974L18.9251 22.7319M32.7447 23.4062L23.4478 33.0994M32.7447 23.4062L27.9706 22.7319M23.4478 33.0994L14.151 23.4062M23.4478 33.0994V24.9234M14.151 23.4062L18.9251 22.7319M23.4478 24.9234L27.9706 22.7319M23.4478 24.9234L18.9251 22.7319" stroke="inherit"></path></svg>
    let k8Image = <svg width="75" height="75" viewBox="0 0 34 34" fill="none" stroke="white"><path d="M17 2.2666L29.4667 11.4213V23.1507M17 2.2666L4.53333 11.4213V23.1507M17 2.2666L4.53333 23.1507M17 2.2666L29.4667 23.1507M29.4667 23.1507L17 31.7333L4.53333 23.1507M29.4667 23.1507H4.53333" stroke="inherit"></path></svg>
    let k6Image = <svg width="75" height="75" viewBox="0 0 34 34" fill="none" stroke="white"><path d="M30.6 9.3527L17.1417 1.69995L3.68335 9.3527M30.6 9.3527V24.1468L17.1417 32.0166M30.6 9.3527L17.1417 17.447M17.1417 32.0166L3.68335 24.1468V9.3527M17.1417 32.0166V17.447M3.68335 9.3527L17.1417 17.447" stroke="inherit"></path></svg>
    let k4Image = <svg width="75" height="75" viewBox="0 0 34 34" fill="none" stroke="white"><path d="M18.3356 4.53345L31.7334 15.8905L25.3661 29.4668M18.3356 4.53345L2.55005 23.0703L25.3661 29.4668M18.3356 4.53345L25.3661 29.4668" stroke="inherit"></path></svg>
    let k2Image = <svg width="75" height="75" viewBox="0 0 34 34" fill="none" stroke="white"><circle cx="17" cy="17.0003" r="10.3182" stroke="inherit"></circle><circle cx="16.9999" cy="17.0002" r="13.4091" stroke="inherit"></circle></svg>
    ...
    return (
        <div className={classes.contentContainer}>
                ...
                <div className={classes.dicesContainer}>
                        <Dice image={k20Image} title='20'/>
                        <Dice image={k12Image} title='12'/>
                        <Dice image={k10Image} title='10'/>
                        <Dice image={k100Image} title='100'/>
                        <Dice image={k8Image} title='8'/>
                        <Dice image={k6Image} title='6'/>
